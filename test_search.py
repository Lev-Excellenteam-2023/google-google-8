...
class TestCalculations(unittest.TestCase):
    ...
    def test_find_in_dict(self):
        search_wards.init_system("C:\\networks\\google8\\google-google-8\\Archive1")
        self.assertEqual(search_wards.find_in_dict(2), insertion.SentenceInfo(sentence='Bitbucket Server documentation home documentation \n',
    ...
    def test_correction_to_input(self):
        search_wards.init_system("C:\\networks\\google8\\google-google-8\\Archive1")
        self.assertEqual(search_wards.correction_to_input(["bome", "documentation"]),{'home documentation': [2, 3, 4, 5, 6, 7], 'vome documentation': [8]})
        self.assertEqual(search_wards.correction_to_input(["ome", "documentation"]),{'home documentation': [2, 3, 4, 5, 6, 7], 'vome documentation': [8]})
        self.assertEqual(search_wards.correction_to_input(["bomke", "documentation"]),{})
        self.assertEqual(search_wards.correction_to_input(["hdome", "documentation"]),{'home documentation': [2, 3, 4, 5, 6, 7]})
